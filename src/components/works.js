 ...
 class Works extends Component {
  render() {
    return (
        ...
        <div className="image"><img src="http://101musicalsacademy.in/wp-content/uploads/2016/05/IMG_7282-e1464516797638.jpg" alt="sample52" style={{width:440,height:250}}/></div>
        <figcaption>
      ...
      <figure className="snip1253 hover">
      <div className="image"><img src="liveshow.png" alt="sample66" style={{width:440,height:250}}/></div>
        <figcaption>
          <h3> Live Band Performances  </h3>
          <p>
           Performing live in college festivals , and band competitions all over india. We Constantly keep working on new songs and tracks to entertain our audiences.
          </p>
        </figcaption>
        
      </figure>
      <figure className="snip1253">
        <div className="image"><img src="musicsite.png" alt="sample52" style={{width:440,height:250}}/></div>
        <figcaption>
      ...
      <figure className="snip1253">
        <div className="image"><img src="basicsguitar.png" alt="sample52" style={{width:440,height:250}}/></div>
        <figcaption>
          <h3>Launched Youtube Videos Viewing App on App Store. </h3>
          <p>
      ...
      <figure className="snip1253 hover">
        <div className="image"><img src="live.png" alt="sample66" style={{width:440,height:250}}/></div>
        <figcaption>
      ...
      <figure className="snip1253">
        <div className="image"><img src="news.png" alt="sample59" style={{width:440,height:250}}/></div>
        <figcaption>
